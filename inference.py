...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained-model-path", type=str, default="AnimateDiff/models/StableDiffusion/stable-diffusion-v1-5",)
    parser.add_argument("--inference-config",      type=str, default="AnimateDiff/configs/inference/inference-v3.yaml")
